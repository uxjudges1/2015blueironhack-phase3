...
/**
 * @ngdoc directive
 * @name 2015blueironhackWeiqingApp.directive:ngPlacesAutocomplete
 * @description
 * # ngPlacesAutocomplete
 */
angular.module('2015blueironhackWeiqingApp')
  .directive('ngPlacesAutocomplete', function ( mapInitializer ) {
        ...
        return {
            ...
            link: function (scope, element, attributes, ngModel) {
                // Do some dirty checking to inform the user if the setup is wrong
                 var autocomplete,
	                    acService, // acService needed to manual search
	                    dummyDiv, // we need a dummy div since the placesService needs an HTML Element (usually a map) to be instantiated
	                    placesService; // PlacesService needed for detailed search
